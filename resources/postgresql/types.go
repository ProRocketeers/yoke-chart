...
// -----------------------
// copied from https://github.com/zalando/postgres-operator/blob/master/pkg/apis/acid.zalan.do/v1/postgresql_type.go
// normally, `go get github.com/zalando/postgres-operator` and regularly importing these types would work (and it does, in the editor)
// however, it pulls all the dependencies of the entire operator, and some of them don't seem to work when compiling into WASM
// -----------------------
